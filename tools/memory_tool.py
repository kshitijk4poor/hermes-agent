...
MEMORY_SCHEMA = {
    ...
    "description": (
        ...
        "ROUTING GUIDE:\n"
        "- Stable personal preferences -> target='user'\n"
        "- Stable environment or project facts -> target='memory'\n"
        "- Reusable procedures or workflows -> use skill_manage instead\n"
        "- Recurring product/system failures -> create a plan, issue, or code follow-up instead\n\n"
